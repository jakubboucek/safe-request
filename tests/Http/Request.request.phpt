...
test('', function () {
    ...
    Assert::same(
        'x%20param=val.&pa%25ram=val2&quotes%5C%22=%5C%22&param3=v%20a%26l%3Du%2Be',
        $request->getUrlWithUserCredential()->query
    );
    Assert::same(
        'x%20param=val.&pa%25ram=val2&quotes%5C%22=%5C%22&param3=v%20a%26l%3Du%2Be',
        $request->getUrlWithUserCredential()->query
    ...
    Assert::same(
        'file.php?x%20param=val.&pa%25ram=val2&quotes%5C%22=%5C%22&param3=v%20a%26l%3Du%2Be',
        $request->getUrl()->relativeUrl
    );
    Assert::same(
        'https://nette.org:8080/file.php?x%20param=val.&pa%25ram=val2&quotes%5C%22=%5C%22&param3=v%20a%26l%3Du%2Be',
        $request->getUrl()->absoluteUrl
    );
...
test('', function () {
    ...
    Assert::same('/file.php', $request->getUrl()->path);
    Assert::same(
        'x%20param=val.&pa%25ram=val2&quotes%5C%22=%5C%22&param3=v%20a%26l%3Du%2Be%29',
