...
class RequestFactorySchemeTest extends Tester\TestCase
{
    ...
    public function providerCreateHttpRequest(): array
    {
        return [
            ...
            [
                'http',
                ['SERVER_NAME' => 'localhost:80', 'HTTP_X_FORWARDED_PROTO' => 'https', 'HTTP_X_FORWARDED_PORT' => '443']
            ],
    ...
    public function providerCreateHttpRequestWithTrustedProxy(): array
    {
        return [
            ...
            [
                'http',
                80,
                ['SERVER_NAME' => 'localhost:443', 'HTTPS' => 'on', 'HTTP_X_FORWARDED_PROTO' => 'something-unexpected']
            ],
            [
                'http',
                443,
